...
-- ----------------------------
INSERT INTO `permission` VALUES (1, '员工管理', 0, '/admin/user/mainToAdmin', 1, 1);
INSERT INTO `permission` VALUES (2, '员工添加', 1, '/admin/user/addNewAdmin', 0, 1);
INSERT INTO `permission` VALUES (3, '员工删除', 1, '/admin/user/delAdminById', 0, 1);
INSERT INTO `permission` VALUES (4, '员工修改', 1, '/admin/user/updateGoAdminById', 0, 1);
INSERT INTO `permission` VALUES (6, '用户管理', 0, '/admin/user/mainToUserinfo', 1, 1);
INSERT INTO `permission` VALUES (9, '用户删除', 6, '/admin/user/delUserinfoById', 0, 1);
INSERT INTO `permission` VALUES (10, '用户修改', 6, '/admin/user/updateGoUserinfoById', 0, 1);
INSERT INTO `permission` VALUES (13, '订单管理', 0, '/admin/order/mainToAdminOrder', 1, 1);
INSERT INTO `permission` VALUES (14, '订单修改', 13, '/admin/order/updateSelectAdminOrder', 0, 1);
INSERT INTO `permission` VALUES (15, '订单删除', 13, '/admin/order/deleteAdminOrder', 0, 1);
INSERT INTO `permission` VALUES (16, '详情修改', 13, '/admin/order/updateSelectAdminOrderDetial', 0, 1);
INSERT INTO `permission` VALUES (17, '详情删除', 13, '/admin/order/deleteOrderdetail', 0, 1);
INSERT INTO `permission` VALUES (19, '图片管理', 0, '/admin/img/mainToAdminImg', 1, 1);
INSERT INTO `permission` VALUES (20, '上传图片', 19, '/admin/img/upload', 0, 1);
INSERT INTO `permission` VALUES (21, '商品管理', 0, '/admin/snackinfo/mainToAdminSnackinfo', 0, 1);
INSERT INTO `permission` VALUES (22, '商品上架', 21, '/admin/snackinfo/addAdminSnack', 0, 1);
INSERT INTO `permission` VALUES (23, '商品删除', 21, '/admin/snackinfo/delAdminUserinfo', 0, 1);
INSERT INTO `permission` VALUES (24, '商品修改', 21, '/admin/snackinfo/selectAdminUserinfoBysId', 0, 1);
INSERT INTO `permission` VALUES (25, '个人信息', 0, '/admin/user/mainToAdminuser', 1, 1);
INSERT INTO `permission` VALUES (26, '确认发货', 13, '/admin/order/userOrderConfirm', 0, 1);
