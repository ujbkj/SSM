...
public class AdminController {
    ...
    public ModelAndView admin_category_add(@RequestParam("name") String name, @RequestParam("filepath") MultipartFile filepath) throws IOException {
        ...
        String path1 = "D:\\Intellij-2021\\Gotrip-master\\src\\main\\webapp\\img\\category\\"+cid.toString()+".jpg";
        String path2 = "D:\\Intellij-2021\\Gotrip-master\\target\\Gotrip\\img\\category\\"+cid.toString()+".jpg";
